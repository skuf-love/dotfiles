...
-- Autocmd is working but I'll go with Ale and then will try to set up lsp
-- Ale autocorrect for some reason isn't working
vim.api.nvim_create_autocmd({ 'BufWritePost', 'FileWritePost' }, {
  desc = 'Run standardb on a saved file',
  pattern = { '*.rb' },
  callback = function(args)
    local output = vim.fn.system { 'standardrb', '--fix', args.file }
    print(output)
    vim.cmd 'e!'
  end,
})
...
require('lazy').setup({
  ...
  --{ # produces a lot of not usefull noise
